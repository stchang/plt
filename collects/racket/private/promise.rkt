...
(#%provide force promise? promise-forced? promise-running? composable-promise?
...
;(define-for-syntax (stepper-syntax-property stx tag) stx)
#;(define-for-syntax (stepper-syntax-property stx tag)
  (letrec-values ([(stepper-props) (syntax-property stx 'stepper-properties)])
    (if stepper-props
        (letrec-values ([(table-lookup) (assq tag stepper-props)])
          (if table-lookup
